...
<html lang="en">
    <head>
        ...
        <!-- africlick styles -->
        <?php echo css_asset('africlick.css', 'africlick'); ?>
        ...
        <?php echo js_asset('trdb.js', 'africlick'); ?>
        ...
        <div id="navbar" class="navbar navbar-default">
            ...
            <div class="navbar-container" id="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    ...
                    <h4 class="white" id="id-company-text">africlick</h4>
                                ...
                                if ($menu->module_id > 0) {
                                    ...
                                    <style>
                                        <?php echo ".ace-nav > li.$menu->module_name"; ?> a{
                                            background: url("<?php echo image_asset_url('menu_icon/' . $menu->icon, 'africlick'); ?>") 4px 2px no-repeat;
                                        }
                                        <?php echo ".ace-nav > li.$menu->module_name"; ?> a:hover{
                                            background: url("<?php echo image_asset_url('menu_icon/' . $menu->hover_icon, 'africlick'); ?>") 4px 2px no-repeat;
                                        }
                                    </style>
                                <?php } else { ?>
...
<![endif]-->
        ...
        <?php echo js_asset('typeahead.bs3.js', 'africlick'); ?>
        <!-- inline scripts related to this page -->
        <?php echo js_asset('notify.min.js', 'africlick'); ?>
